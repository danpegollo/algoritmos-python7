**Escreva um programa em Python que peça para o usuário digite um texto** 

(mensagem: “Digite um texto: ”) e depois para digitar um número (mensagem: “Digite um número”). 
